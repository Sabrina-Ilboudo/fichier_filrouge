...
@section('content')
    ...
    <div style="margin-top: 10px; margin-left: 200px;">
        <p>
        <h3><strong>Catégorie 4</strong></h3>
        </p>
    </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    <div>
                            <img src="{{URL::to('/')}}/img/w1.jpg" class="card-img-top" alt="Fissure in Sandstone" />
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/s9.jpg" class="card-img-top" alt="Fissure in Sandstone" />
            ...
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/x1.jpg" class="card-img-top" alt="Fissure in Sandstone" />
            ...
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/X6.jpg" class="card-img-top" alt="Fissure in Sandstone" />

                    <div class="card-body">
                        <h5 class="card-title">16 000F CFA</h5>
                        <p>Pagne traditionnel kok </p>
                        <a href="https://wa.me/69679649">
                            <button type="button" class="btn btn-outline-success">
                                <img src="{{URL::to('/')}}/img/whatapp.jpeg" alt="whatapp" width="45px" height="45px">
                                Whatapp
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/X8.jpg" class="card-img-top" alt="Fissure in Sandstone" />
            ...
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/X7.jpg" class="card-img-top" alt="Fissure in Sandstone" />
            ...
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/H.jpg" class="card-img-top" alt="Fissure in Sandstone" />
            ...
            <div class="col-md-3">
                <div class="card" style="background: transparent;">
                    ...
                    <img src="{{URL::to('/')}}/img/w3.jpg" class="card-img-top" alt="Fissure in Sandstone" />
